...
public class OrgUnitLevelService {
    ...
    public OrgUnitLevelService(OrgUnitLevelRepository orgUnitLevelRepository) {
    ...
    public OrgUnitLevel save(OrgUnitLevel orgUnitLevel) {
        log.debug("Request to save OrgUnitLevel : {}", orgUnitLevel);        return orgUnitLevelRepository.save(orgUnitLevel);
    }
